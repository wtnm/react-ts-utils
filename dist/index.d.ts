...
declare function string2path(path: string, { str2sym, replace }?: any): any[];
declare const isElemRef: (val: any) => boolean;
declare function skipKey(key: string, obj?: any, opts?: any): number | boolean;
declare function resolvePath(path: any[], base?: any[]): any[];
declare function objectDerefer(_elements: any, obj2deref: any, opts?: any, track?: string[], baseObj?: any): any;
